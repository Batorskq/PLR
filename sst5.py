...
def parse_args():
    ...
    ap.add_argument("--infer-path", type=str, default="dataset/sst5_infer.jsonl", help="Path to sst5_infer.jsonl.")
    ap.add_argument("--test-path", type=str, default="dataset/sst5_test.jsonl", help="Path to sst5_test.jsonl.")
...
def main():
    ...
    results_path = os.path.join(results_dir, "sst5.txt")
    ...
    infer_items = load_sst5_items(args.infer_path, show_tqdm=show_tqdm)
    test_items = load_sst5_items(args.test_path, show_tqdm=show_tqdm)
