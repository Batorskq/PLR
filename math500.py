...
from utils.math500_utils import (
    log,
    set_all_seeds,
    load_math500_items,
    Math500GenerationEvaluator,
...
def main():
    ...
    p.add_argument("--model-path", type=str, default="/gpfs/project/lox20cow/ms-swift/qwen7binstruct")
    p.add_argument("--infer-path", type=str, default="dataset/math500_infer.jsonl")
    p.add_argument("--test-path", type=str, default="dataset/math500_test.jsonl")
    p.add_argument("--results-path", type=str, default="results/math500_runs.jsonl")
    ...
    infer_items = load_math500_items(args.infer_path, show_tqdm=True)
    test_items = load_math500_items(args.test_path, show_tqdm=True)
