...
def parse_args():
    ...
    ap.add_argument("--infer-path", type=str, default="dataset/mr_infer.jsonl", help="Path to mr_infer.jsonl.")
    ap.add_argument("--test-path", type=str, default="dataset/mr_test.jsonl", help="Path to mr_test.jsonl.")
...
def main():
    ...
    results_path = os.path.join(results_dir, "mr.txt")
    ...
    infer_items = load_mr_items(args.infer_path, show_tqdm=show_tqdm)
    test_items = load_mr_items(args.test_path, show_tqdm=show_tqdm)
